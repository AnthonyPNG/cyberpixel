...
INSERT INTO `cb` (`idcb`, `num`, `date`, `cryptogramme`, `solde`) VALUES 
(1, 4970101234567890, "08/25", 398, 1023.60),
(2, 4971417834619078, "01/24", 891, 12.25),
(3, 4973000000000000, "07/24", 321, 253.03);
...
INSERT INTO `user` (`idclient`, `nom`, `prenom`, `mail`, `adresse`, `estconnecte`, `role`, `passer_commande`, `payer_commande`, `mdp`) VALUES 
(1, 'admin', 'admin', 'admin@cy-tech.fr', 'Av. du Parc, 95000 Cergy', DEFAULT, 'admin', DEFAULT, DEFAULT, 'Cypjcaaj'),
(2, 'Dupont', 'Jean', 'jean.dupont@gmail.com', '185 rue de Lancry, 75010 Paris', DEFAULT, 'client', DEFAULT, DEFAULT, 'azertyuiop'),
(3, 'Dupuit', 'Martin', 'dupuitmart1@yahoo.fr', '350 rue Saint-Guillaume, 75007 Paris', DEFAULT, 'client', DEFAULT, DEFAULT, '123456789'),
(4, 'Rochet', 'Lea', 'learochet.yt@gmail.com', '208 rue au Maire, 75003 Paris', DEFAULT, 'client', DEFAULT, 0, 'qwerty0000'),
(5, 'Laroche', 'Pierre', 'pierre.lrch@gmail.com', '148 rue du 8 mai 1945, 92000 Nanterre', DEFAULT, 'client', 0, 0, 'zaza1234');